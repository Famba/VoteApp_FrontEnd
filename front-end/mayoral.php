						...
						<form action="<?=basename(__FILE__)?>" method="post" accept-charset="utf-8">
							<div class="clearfix">
								<div class="input democrat">
									<input type="radio" name="mayor"  value="J.R. Clairborne"> Kishan Pars
								</div>
							</div>
							<div class="clearfix">
								<div class="input peoples-emancipation-party">
									<input type="radio" name="mayor"  value="Anthony Gallucci"> Aubrey Freddy
								</div>
							</div>
							<div class="clearfix">
								<div class="input republican">
									<input type="radio" name="mayor"  value="Janis Kelly"> Dylan Sept
								</div>
							</div>
							<div class="clearfix">
								<div class="input independent">
									<input type="radio" name="mayor"  value="Christopher Kusznir"> Jacob Zuma
								</div>
							</div>
							<div class="clearfix">
								<div class="input democrat">
									<input type="radio" name="mayor"  value="Pam Mackesy"> Julius Malema
								</div>
							</div>
							<div class="clearfix">
								<div class="input democrat">
									<input type="radio" name="mayor"  value="Svante Myrick"> John Champion
								</div>
							</div>
							<div class="clearfix">
								<div class="input independent">
